...
<body>
    ...
    <header style="background-color: #bbb;">
        ...
        <nav class="navigation">
            ...
            <a href="donationn.php">Donation</a>
            <a href="
            ...
            " onclick="<?php if(!isset($_SESSION['UID'])) { echo "alert('Please log in to adopt a pet.');"; } ?>"
            >Adopt</a>
            <?php
                ...
                if (isset($_SESSION['FULL_NAME'])) {
                    echo '
                        ...
                        <div class="dropdown-content" id="profileDropdown">
                            <a href="listing.php" id="logoutLink">List for Adoption</a>
                            <a href="view_listing.php" id="logoutLink">Listing</a>
                            <a href="adoption_req.php" id="logoutLink">Adoption Requests</a>
